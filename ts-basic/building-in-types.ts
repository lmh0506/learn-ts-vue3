...
let test1: IMan = {name: '12', age: 12}
// Partial 它可以把传入的类型都变成可选
type PartialPerson = Partial<IMan>
let test2: PartialPerson = {name: '12'}
let test3: PartialPerson = {age: 12}
// Omit 它返回的类型可以忽略传入类型的某个属性
type OmitPerson = Omit<IMan, 'name'>
let test4: OmitPerson = {age: 12}